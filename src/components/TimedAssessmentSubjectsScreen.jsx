const TimedAssessmentSubjectsScreen = ({ classNum, subjects, isLoading, onSelect, onBack }) => {
  return (
    <div className="glass-card w-full max-w-2xl animate-slideUp">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-12">
          ...
          <p className="text-gray-500 dark:text-gray-400">No subjects with active assessments</p>
        </div>
      ) : (
          ...
          {subjects.map((subject) => (
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-500 dark:text-gray-400">View assessments</div>
              </div>
...
export default TimedAssessmentSubjectsScreen;
